            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Upload your resume, and we'll create a professional portfolio
                  website for you in minutes. Showcase your skills and
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Choose from various themes and customize colors to match your
                  style.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border-gray-200 p-4 rounded-lg">
                <div className="bg-primary text-primary-foreground rounded-full p-2 w-8 h-8 flex items-center justify-center text-lg font-bold">
                  1
                </div>
                <h3 className="text-xl font-bold">Upload Your Resume</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Upload your existing resume or CV in PDF, Word, or plain text
                  format.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-200 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  Choose a theme, adjust colors, and add any additional
                  information you want to showcase.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-200 p-4 rounded-lg">
                <div className="bg-primary text-primary-foreground rounded-full p-2 w-8 h-8 flex items-center justify-center text-lg font-bold">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  With one click, publish your new portfolio website and start
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="bg-white dark:bg-gray-950 p-6 rounded-lg shadow-lg">
                <p className="text-gray-500 dark:text-gray-400 mb-4">
                  "This tool saved me hours of work. I had a
                  professional-looking portfolio site up in no time!"
                </p>
              ...
              <div className="bg-white dark:bg-gray-950 p-6 rounded-lg shadow-lg">
                <p className="text-gray-500 dark:text-gray-400 mb-4">
                  "I'm not tech-savvy, but this made creating a portfolio so
              ...
              <div className="bg-white dark:bg-gray-950 p-6 rounded-lg shadow-lg">
                <p className="text-gray-500 dark:text-gray-400 mb-4">
                  "The customization options are great. My portfolio truly
                  reflects my personal brand now."
                </p>
                <p className="font-semibold">
                  - Michael Chen, Marketing Specialist
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Create your professional portfolio website in minutes. No
                  coding required.
                </p>
              </div>
