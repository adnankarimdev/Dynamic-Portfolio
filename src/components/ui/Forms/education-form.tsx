  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <Input id="href" name="href" type="url" value={formData.href} onChange={handleChange} required />
      </div>
      <div>
      ...
      <Button type="submit">{editingItem ? "Update Education" : "Add Education"}</Button>
    </form>
  )
}
